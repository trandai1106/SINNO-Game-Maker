...
export default class Actor extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene, x, y, texture) {
        ...
        .setOrigin(0.5)
        .setPipeline('Light2D');
        this.lightPlayer = scene.lights.addLight(x, y, 2900)
        .setColor(0x75d9a5)
        .setIntensity(2);
        ...
        this.body.setSize(112, 280).setOffset(200, 150);
    ...
    // set Light 
    setLight() {
        this.lightPlayer.x = this.x;
        this.lightPlayer.y = this.y;
    }
    ...
    hurt() {
        if (this.isHurt == true && this.Immortal == false) {
            this.health -= 1;
            this.isHurt = false;
            this.Immortal = true;
            setTimeout(() => {
